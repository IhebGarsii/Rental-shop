  ...
  const reviewList = [
    {
      ...
      fullName: "iheb garsi",
      review:
        "Depending on your setup not all types may be available.Expert reviews and user reviews are together referred to as external reviews since they come from external sources, not your own customers.",
    },
    {
      img: "https://www.shutterstock.com/shutterstock/photos/1865153395/display_1500/stock-photo-portrait-of-young-smiling-woman-looking-at-camera-with-crossed-arms-happy-girl-standing-in-1865153395.jpg",
      fullName: "iheb garsi",
  ...
  return (
    <div className="home">
      <div className="header-container">
        <h1 className="home-title">Find Your Realieble Car</h1>
      ...
      <div className="home-cars-container">
        <div className="home-cars">
          {randomCars &&
            randomCars.map((car) => (
              <CarCard car={car} homePage={true} key={car._id} />
            ))}
        </div>
      </div>
        ...
        <div className="about-us">
          <div className="about-left">
            <div className="about-left-top">
              <span>about us</span>
              <h1> Our Something Journey</h1>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Consequuntur ad ratione dolore culpa eligendi. Architecto ut
                suscipit eaque quasi alias.
              </p>
            </div>
        ...
        <div className="card-list">
          {reviewList.map((review, index) => (
            <div className="review-card" key={index}>
              <div className="img">
                <img className="review-avatar" src={review.img} alt="" />
              </div>
              <span>Some Guy</span>
